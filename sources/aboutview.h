...
class DownloadView final : public QWidget {
    Q_OBJECT
public:
    explicit DownloadView(
        QWidget *parent = nullptr,
        QUrl link = QUrl("https://www.elephant-chess.com/wp-content/uploads/2024/"
                         "04/pikafish.zip")) {
        this->parent = parent;
        ...
        QObject::connect(this, SIGNAL(downloaded(QString)), parent,
                         SLOT(onDownloaded(QString)));
...
private slots:
    ...
    void downloadProgress(const qint64 bytesReceived,
