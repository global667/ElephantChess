...
public:
	...
	void makeEntityPickable(Qt3DCore::QEntity* entity);
...
public:
	LoadScene()
	{
		mesh->setSource(QUrl(QUrl::fromLocalFile("F:/source/XiangQi/ElephantChess/res/chinese-chess.fbx/source/ChineseChess.fbx")));
	};
	...
	Qt3DExtras::QTextureMaterial* makeTex(QString name)
	{
		...
		textureImage->setSource(QUrl(QUrl::fromLocalFile(
			"F:/source/XiangQi/ElephantChess/res/board.obj"))); // Xiangqi_Advisor_(Trad)+ wooden.png"))); //wooden.png")));
